...
import 'corporateRegistration2.dart';

class CorporateRegistrationPage extends StatefulWidget {
  const CorporateRegistrationPage({Key? key}) : super(key: key);

  @override
  _CorporateRegistrationPageState createState() => _CorporateRegistrationPageState();
}
              ...
              children: [
                ...
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                      ...
                      elevation: 20),
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>CorporateRegistrationPage2()));
                  },
                )
              ],
            )
