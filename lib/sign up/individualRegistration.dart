...
class IndividualRegistrationPage extends StatefulWidget {
  const IndividualRegistrationPage({Key? key}) : super(key: key);

  @override
  _IndividualRegistrationPageState createState() => _IndividualRegistrationPageState();
}

class _IndividualRegistrationPageState extends State<IndividualRegistrationPage> {
              ...
              children: [
                ...
                TextButton(
                  ...
                  style: TextButton.styleFrom(
                      ...
                      elevation: 20),
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>IndividualRegistrationPage2()));
                  },
                )
              ],
            )
